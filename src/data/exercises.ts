...
export const exercises: ExerciseData[] = [
  ...
  {
    id: "spill-2-lag-1-bane",
    exerciseNumber: 511,
    name: "Spill: 2 lag, 1 bane",
    tags: ["staal", "spill", "2 lag", "1 bane"],
    category: "game",
    duration: 15,
    playersMin: 8,
    playersMax: 18,
    ...
    equipment: ["baller", "mål", "vester"],
    description:
      "Del gruppen i to lag og spill på én bane. Bruk vanlig kampform med tydelig retning, korte kamper og rask igangsetting når ballen går ut.",
    coachingPoints: [
      "Hold laget samlet i både angrep og forsvar",
      "Skap bredde når eget lag har ball",
      "Reager raskt ved balltap og ballvinning",
      "Få alle involvert gjennom tydelige roller og hyppige involveringer",
    ],
    variations: [
      "Touch-styring i blokker: 2 touch i 3 minutter, deretter fritt spill i 3 minutter",
      "Overgangsbonus: mål teller dobbelt ved scoring innen 8 sekunder etter ballvinning",
      "Kantspillkrav: laget må ha minst én pasning via kantrom før mål kan telle",
      "Tredjemannspoeng: ekstra poeng ved scoring etter tredjemannsløp eller veggspill",
      "Pressregel: laget som mister ball må gjenvinne innen 6 sekunder, ellers frispill til motstander",
      "Ulikt overtall: spill 7v6 i korte perioder og bytt roller mellom lagene",
    ],
    source: "staal",
    scalable: true,
  },
  ...
  },
  {
    ...
    equipment: ["baller", "kjegler"],
    description:
      "Lagstafett der to eller flere lag konkurrerer mot hverandre. Spillerne står i kø bak startlinjen. Første spiller fører ball ut til vendepunkt og tilbake, leverer til neste i køen. Laget som fullfører først vinner. Velg variant ut fra treningens tema.",
    coachingPoints: [
      "Hold ballen tett på foten under press og fart",
      "Ren overlevering til neste – ballen må være i ro før neste starter",
      "Oppmuntre lagkamerater i køen",
      "Bruk vendinger med såle eller utside ved vendepunktet",
    ],
    variations: [
      "Føringsstafett: fører ball rundt kjegle og tilbake",
      "Driblingstafett: sikk-sakk gjennom 4–6 kjegler med ball",
      "Vendingsstafett: fører ball til kjegle, gjør vending (såle/utside/Cruyff), fører tilbake",
      "Pasningsstafett: spiller pasning til makker ved vendepunkt, makkeren fører tilbake",
      "Avslutningsstafett: fører ball + skudd på mål, henter ball og leverer til neste",
      "Kombinasjonsstafett: pasning/mottak + føring gjennom kjegler + vending + retur",
      "Uten ball: sprintstafett med ulike løpsoppgaver (sidesteg, baklengs, spensthopp)",
      "Hinderløype: ball gjennom kjegler + hopp over hekk + vending + sprint tilbake",
    ],
    source: "staal",
  },
  {
