...
export const exercises: ExerciseData[] = [
  ...
  },
  {
    ...
    variations: [
      "Juster banestørrelse etter antall spillere",
      "Legg inn maks touch for høyere tempo",
      "Spill med joker hvis ett lag mangler spiller",
      "Tell ekstra poeng for scoring etter gjenvinning",
    ],
    source: "staal",
    scalable: true,
  },
