...
export const glossaryTerms: Record<string, GlossaryTerm> = {
  "2-og-3-bevegelse": {
    ...
    definition: "Løpene som kommer etter førstebevegelsen. 2.-bevegelsen skaper eller åpner rom (trekker med seg forsvarer), og 3.-bevegelsen angriper rommet som åpnes. Handler om timing idet pasningen slås, høy fart og tydelig retning (mellomrom/bakrom).",
    example: "Spiss går i førstebevegelse og drar stopper ut; kant/indre angriper rommet som åpnes i 2.-/3.-bevegelse når pasningen slås.",
  },
  "treplustwo": {
    id: "treplustwo",
    term: "3+2-sikring",
    definition: "Prinsipp for restforsvar: ha minst tre spillere igjen bak ballen, pluss to sentrale sikringer, før laget sender mange i angrep. Gjør laget mer robust ved balltap og reduserer risiko for kontring.",
    example: "Vi kan fylle på i boksen når vi har 3+2 bak ballen; hvis ikke må én bli igjen som sikring.",
  },
  "aggressivitet-i-1f-front": {
    id: "aggressivitet-i-1f-front",
    term: "Aggressivitet i 1F-front",
    definition: "I press: Førsteforsvarer (1F) må gå i press med intensitet og riktig timing. Start idet pasningen slås, sett fart i pressløpet og kom tett nok til å styre ballfører (lede, stresse, hindre framoverpasning).",
    example: "1F starter idet pasningen slås – vær tett på motstanders 1A i mottaksøyeblikket, så får de dårlig tid.",
  },
  "alene": {
    id: "alene",
    term: "Alene!",
    definition: "Rop som varsler at mottaker er uten direkte press og kan vende eller velge løsning i ro.",
    example: "«Alene!» – vend opp og løft blikket før du spiller videre.",
  },
  "andre-stolpe": {
    id: "andre-stolpe",
    term: "Andre stolpe",
    definition: "Det borterste området i boksen, lengst fra der ballen slås. Ofte mer rom fordi forsvar og keeper prioriterer første stolpe.",
    example: "På innlegg: ett løp på første stolpe, ett løp på andre stolpe i fart, og én spiller på retur.",
  },
  "andreangriper-2a": {
    id: "andreangriper-2a",
    term: "Andreangriper (2A)",
    definition: "Nærmeste medspiller til ballfører (1A) som er spillbar. Tilbyr støtte (vegg, støttepasning) eller bevegelse som skaper pasningsvinkel og rom.",
    example: "Avklar roller: 1A er ballfører, 2A gir støtte (spillbar for vegg), og 3A truer rom (dybde/bakrom).",
  },
  "andreballer": {
    id: "andreballer",
    term: "Andreballer",
    definition: "Ballene som faller ned etter duell, klarering eller blokkering (ikke første duell om ballen). Handler om å være i riktig posisjon og reagere raskt for å vinne ballen tilbake.",
    example: "Ved innlegg eller skudd: fyll returrom (D) og vær først på andreballen.",
  },
  "andrebevegelse": {
    id: "andrebevegelse",
    term: "Andrebevegelse",
    definition: "Løpet som kommer etter førstebevegelsen for å utnytte rommet som åpnes. Typisk: én møter i støtte (f.eks. spiss eller indreløper), mens en annen løper i bakrom (spiss/ving/indreløper) idet pasningen slås.",
    example: "Spiss møter og drar stopper ut; ving eller indreløper angriper bakrommet i fart idet pasningen slås.",
  },
  "andreforsvarer-2f": {
    id: "andreforsvarer-2f",
    term: "Andreforsvarer (2F)",
    definition: "Spilleren nærmest førsteforsvarer (1F). Sikrer presset ved å dekke rommet bak/ved siden av 1F og være klar hvis 1F blir passert. Hvis du er på feil side: kom på rett side raskt og gi sikring.",
    example: "2F tar innsiden og sikrer bak 1F, slik at 1F kan lede ballfører ut mot siden.",
  },
  "andreforsvarer": {
    id: "andreforsvarer",
    term: "Andreforsvarer (Sikring)",
    definition: "Sikringsspilleren bak/nær førsteforsvarer. Dekker farlig rom (bakrom og pasningslinje inn), og er beredskap hvis 1F blir passert. Hvem som sikrer hvem avhenger av rolle og posisjon; avstand justeres etter fart hos 1A og hvor mye rom som må beskyttes.",
    example: "Når backen støter som 1F, faller stopperen av som sikring og roper «Jeg sikrer!».",
  },
  "anker-6": {
    id: "anker-6",
    term: "Anker (6)",
    definition: "Den dype sentrale midtbanespilleren foran forsvarslinja (ofte «sekseren»). Beskytter rommet foran stopperne, er spillbar i oppbygging og styrer rytme (vende/spille gjennom) med posisjon og valg.",
    example: "Ankeret holder seg spillbart foran stopperne og gir laget et trygt vendingspunkt sentralt.",
  },
  "balanse": {
    id: "balanse",
    term: "Balanse (defensiv)",
    definition: "Restforsvar når laget angriper: ha nok spillere bak ballen og kontroll på sentrale rom, slik at dere tåler balltap og kan stoppe kontring tidlig. Praktiske regler: «Balanse før du går» og «ikke gå høyt uten sikring». Startpunkt: 3+2 igjen før dere overbelaster, og når kontringstrussel er høy: én går – én sikrer.",
    example: "Vi har dårlig balanse – begge backene er høyt, og vi har verken 3+2 igjen eller sikring sentralt ved balltap.",
  },
  "balanse-forsvar": {
    id: "balanse-forsvar",
    term: "Balanse (forsvar)",
    definition: "Beskriver om laget i etablert forsvar har kontroll: press på ballfører, sikring bak presset og dekning av farlige rom/pasningslinjer. Når rollene er fylt og avstandene er riktige, har laget posisjonell balanse.",
    example: "Vi har god balanse: 1F presser, 2F sikrer bak, og resten dekker rom og pasningslinjer sentralt.",
  },
  "ballbehandlingstid": {
    id: "ballbehandlingstid",
    term: "Spill på få touch (slå og gå)",
    definition: "Prinsipp i pasningsspillet: bruk få berøringer og flytt deg etter avlevering. Målet er høyere tempo, mindre tid til press og bedre flyt – men det krever orientering før mottak og riktig støtteavstand.",
    example: "1–2 touch: slå til nærmeste rettevendte, og gå direkte for ny vinkel (slå og gå).",
  },
  "ballbesittelse": {
    id: "ballbesittelse",
    term: "Ballbesittelse (possession)",
    definition: "Kontrollert ballinnehav for å flytte motstanderen, trekke ut markeringer og skape rom før gjennombrudd. Ikke et mål i seg selv, men et middel for å styre tempo, hvile med ball og skape bedre angrepsbilder. Krever støttevinkler, orientering og bevegelse uten ball.",
    example: "Vi holder ballen for å overflytte presset, så vender vi raskt og angriper gratisrommet på motsatt side.",
  },
  "bearbeidingsfasen": {
  ...
  "lese-spillet": {
    ...
    example: "Hun leste pasningen tidlig og brøt foran mottaker.",
  },
